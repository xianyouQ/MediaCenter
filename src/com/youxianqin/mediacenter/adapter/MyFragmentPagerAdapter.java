...
import com.youxianqin.mediacenter.MyFragment;
import com.youxianqin.mediacenter.bean.VideoType;

public class MyFragmentPagerAdapter extends FragmentPagerAdapter {

	private ArrayList<MyFragment> MyFragmentList;
	private ArrayList<VideoType> VideoTypeList;
        public MyFragmentPagerAdapter(FragmentManager fm,ArrayList<MyFragment> MyFragmentList,ArrayList<VideoType> VideoTypeList) {
		super(fm);
