...
public class CopyOfVideoPlayActivity extends Activity implements  OnInfoListener, OnBufferingUpdateListener{
...
class VideoDownLoad extends NetWorkStringDownLoad{
		...
		protected void onPostExecute(String result) {
			// TODO Auto-generated method stub
			  ...
			  {
				  Toast.makeText(CopyOfVideoPlayActivity.this,constant.NETWORK_ERROR_STRING, Toast.LENGTH_LONG).show();
